...
export function Chat() {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      {/* Messages - área de scroll optimizada con padding dinámico CSS */}
      <div className="chat-messages-area flex-1 overflow-y-auto px-4 py-4 pb-32">
        <MessageList
          messages={messages}
          isLoading={isLoading}
      ...
      {/* Input - padding dinámico controlado por CSS :has() */}
      <div className="chat-input-area flex-shrink-0 pb-28">
        <ChatInput
          value={inputText}
